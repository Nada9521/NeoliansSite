...
public class CssSelectorToXPathConverterInvalidFirstLastOnlyOfType extends CssSelectorToXPathConverterException {
	...
	public static final String FIRST_LAST_ONLY_OF_TYPE_UNSUPPORTED_ERROR_FORMAT = "Unable to convert a CSS Selector with \"*\" or \"\" before pseudo class :first-of-type/:last-of-type/:only-of-type to a XPath";
